...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
        ...
        map.insert("password".to_string(), "LkjhgfdsA".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["oiio.top"];
pub const RS_PUB_KEY: &str = "Ac6GOXJBat7ndRmZNBsvgCFAJoezM0yHkJmzGfyzINY=";
